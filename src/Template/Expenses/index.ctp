<div class="container-fluid py-4 px-5">
    <nav aria-label="breadcrumb" style="margin-bottom: 20px; margin-top: -50px;">
        <ol class="breadcrumb bg-transparent mb-1 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Contas a Pagar</li>
        </ol>
    </nav>
    <div class="row">
        <div class="col-12">
            <div class="card border shadow-xs mb-4">
                <div class="card-header border-bottom pb-0">
                    <div class="d-sm-flex align-items-center justify-content-between">
                        <div>
                            <h6 class="font-weight-semibold text-lg mb-0">Contas a Pagar</h6>
                            <p class="text-sm">Estes são as contas a pagar cadastradas...</p>
                        </div>
                        ...
                        <div style="text-align: right;">
                            <a class="nav-link " href="<?= $this->Url->build(['controller' => 'Expenses', 'action' => 'add']) ?>" role="button">
                                ...
                                <span class="nav-link-text ms-1">Adicionar Conta a Pagar</span>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="card-body px-0 py-0">
                    <div class="border-bottom py-3 px-3 align-items-center">
                        ...
                        <div class="col-12 col-md-3 mb-2">
                            <?= $this->Form->data_personalizada('data_vencimento', 'Data de Vencimento:', 'date', 'dd/mm/yyyy', 'optional', $this->request->getQuery('data_vencimento')); ?>
                        </div>
                        ...
                        <table class="table align-items-center mb-0">
                            <thead class="bg-gray-100">
                                <tr>
                                    ...
                                    <th class="text-center text-secondary text-xs font-weight-semibold opacity-7">Data Vencimento</th>
                            ...
                            <tbody>
                                <?php foreach ($expenses as $expense) : ?>
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                ...
                                                <div class="d-flex flex-column justify-content-center ms-1">
                                                    <h6 class="mb-0 text-sm font-weight-semibold"> <?= $expense->id ?></h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <p class="text-sm text-dark font-weight-semibold mb-0"><?= $expense->description ?></p>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <p class="text-sm text-dark font-weight-semibold mb-0"><?= 'R$ ' . number_format($expense->value, 2, ',', '.'); ?>
                                            </p>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <p class="text-sm text-dark font-weight-semibold mb-0">
                                                <?= $expense->date_maturity->format('d/m/Y') ?>
                                            </p>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <?php if ($expense->status == true): ?>
                                        ...
                                        <td class="align-middle text-center text-sm">
                                            <p class="text-sm text-dark font-weight-semibold mb-0"><?= h($expense->category->name) ?></p>
                                        </td>
                                        <td class="align-middle text-center" style="display: flex; justify-content: end;">
                                            <a class="btn btn-sm btn-dark" href="<?= $this->Url->build(['controller' => 'Expenses', 'action' => 'edit', $expense->id]); ?>">
                                  ...
                                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
                                    <path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z"/>
                                                ...
                                                [
                                                    'confirm' => __('Tem certeza que deseja deletar a conta: {0}?', $expense->description),
                                                    'escapeTitle' => false,
                                                    'escape' => false,
