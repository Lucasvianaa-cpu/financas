                ...
                <div class="card-header border-bottom pb-0">
                    <div class="d-sm-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <p class="text-sm">Estes são as categorias registradas...</p>
                        </div>

                        <div style="text-align: right;">
                            <a class="nav-link " href="<?= $this->Url->build(['controller' => 'Categories', 'action' => 'add']) ?>" role="button">
                        ...
                        <table class="table align-items-center mb-0">
                            <thead class="bg-gray-100">
                                <tr>
                                    ...
                                    <th class="text-center text-secondary text-xs font-weight-semibold opacity-7">É Receita?</th>
                                    <th class="text-center text-secondary text-xs font-weight-semibold opacity-7">É Despesa?</th>
                                ...
                                <?php foreach ($categories as $category) : ?>
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                ...
                                                <div class="d-flex flex-column justify-content-center ms-1">
                                                    <h6 class="mb-0 text-sm font-weight-semibold"> <?= $category->name ?>
                                                    </h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            ...
                                            <p><?= $category->is_receive ? 'Sim' : 'Não'; ?></p>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <p class="text-sm text-dark font-weight-semibold mb-0">
                                            <p><?= $category->is_pay ? 'Sim' : 'Não'; ?></p>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <p class="text-sm text-dark font-weight-semibold mb-0">
                                            <p><?= $category->is_active ? 'Sim' : 'Não'; ?></p>
                                        </td>

                                        <td class="align-middle text-center" style="display: flex; justify-content: end;">
                                            <a class="btn btn-sm btn-dark" href="<?= $this->Url->build(['controller' => 'Categories', 'action' => 'edit', $category->id]); ?>">
                                  ...
                                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
                                    <path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z"/>
                                                ...
                                                [
                                                    'confirm' => __('Tem certeza que deseja deletar a categoria: {0}?', $category->name),
                                                    'escapeTitle' => false,
                                                    'escape' => false,
